...
- セマンティック バージョニング 2.0.0 を元に **X.Y.Z記法**で tag を付けて管理していきます
### 各バージョンの意味
...
3. 登録後は login して頂く事によって、記事・画像の投稿、お気に入りボタンの使用が可能になります。自分の投稿を削除・編集は自由にできます
   - 他の user の投稿の編集・削除はできません
4. prototype Blog site なので、今後の状況によっては App update、以降なのどによって閉鎖・削除する事もございます
   - 使用前には必ず下記の利用規約をご確認下さい
5. 下記の注意事項および利用規約を必ずご確認の上登録してください。登録された方は注意事項および利用規約に同意したものとみなします
## **利用規約**
